                ...
                return (
                  <Row key={id} className="scor fancy_all_data">
                    <Col span={19} className="match_title">
                      ...
                      {
                        keyData !== "Bookmaker" && <span className="fancy_book_data" onClick={()=>hanldeBookSection(res?.sid)}>Book</span>
                      }
                    </Col>
                    <Col data-before-content={res?.gstatus}  className={`${res.gstatus === ""?"":"after_Effect"}`} span={5}>
                      <Row>
                        <Col span={12}>
