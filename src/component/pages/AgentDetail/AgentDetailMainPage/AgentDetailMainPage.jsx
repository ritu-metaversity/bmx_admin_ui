...
import ModalsData from "../../supermaster/listsuper/ModalsData/ModalsData";


const AgentDetailMainPage = () => {
  ...
  const items = [
    ...
    {
      label: <Link to="/client/update-agent">Edit</Link>,
      key: "3",
    },
    {
    ...
    {
      label: <a href="https://www.aliyun.com">Downline</a>,
      key: "3",
    },
    {
      ...
      <div className="main_live_section list_supers">
        ...
        <div>
          <div className="create_btn">
            ...
            <div>
              <p>
                <Link to="/client/limitplusminus-agent">Update Limit</Link>
              </p>
            </div>
          </div>
...
export default AgentDetailMainPage;
